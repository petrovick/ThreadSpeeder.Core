...
namespace ThreadSpeeder.Example.Application
{
    public class UserApplication
    {
        ...
        public List<UserAddressAgeDTO> ProcessWithThreadSpeeder(List<User> users)
        {
            ...
            new br.edu.unipam.core.Thread.Processor.ThreadHelper<List<User>, User, List<UserAddressAgeDTO>, UserAddressAgeDTO>().PreProcessar(users, returnedList, 100, this.MakeYourFuncHere);
            return returnedList;
        }
